...
(function($, window) {
    ...
    function findElementBounds(elem, clip) {
        ...
        if (clip) {
            ...
            bounds.bottom = Math.min(bounds.bottom, $window.scrollTop() + $window.height());
        }
    ...
    var Lens = function(options) {
        ...
        lens = $('<div id="photozoomLens" class="photozoomLens"/>').css({
            'position': 'absolute',
            'background': '#fff',
        ...
        self.resize = function() {
            ...
            lensSize = {
                'width': Math.round(Math.min(image.width(), zoomBoundary.width * zoomRatio)),
                'height': Math.round(Math.min(image.height(), zoomBoundary.height * zoomRatio))
            };
    ...
    var ZoomContainer = function(options) {
        ...
        container = $('<div id="photozoomContainer" class="photozoomContainer"/>').css({
            'position': 'absolute',
            'background': '#fff',
            'overflow': 'hidden',
            'display': 'none'
        ...
        zoomImage = $('<img id="photozoomImage" class="photozoomImage"/>').attr('src', zoomImageSrc).css({
            'position': 'absolute'
        }).appendTo(container);
    ...
    var photozoom = function(options) {
        ...
        var zoomContainer = self.zoomContainer = new ZoomContainer({
            'image': self,
            'target': options.target || '#photozoomWindow',
